...
<script type="text/javascript">
	...
	$(function(){
		...
		$.get(url , function(result){
			...
			$(result).each(function (i , n) { //n 就是customer
	...
	function changeCustomer(){
		//1. 只要选择了具体某个客户，就要求去获取这个客户的所有联系人下来。
		...
		$.post(url , {cid:id} , function(result){
			
			//清空以前的内容
			$("#linkMan").html("<option value=''>-请选择-</option>");
			
			
			$(result).each(function(i , n){ // n -- > 就是linkman对象
				...
				<tr>
					...
					<td vAlign=top width="100%" bgcolor="#ffffff">
						...
						<table cellspacing="0" cellpadding="5" border="0">
							<tr>
								<td>客户名称：</td>
								<td><select name="customer.cust_id" onchange="changeCustomer()" id="customer" class="textbox"
							...
							<tr>
								...
								<td><%-- <s:textfield class="textbox" style="width: 180px"
										maxLength="50" name="visit_interviewee" /> --%>
									<select name="linkMan.lkm_id" id="linkMan" class="textbox"
										style="width: 180px; height: 21px;">
											<option value="">请选择</option>
									</select>	
								</td>
