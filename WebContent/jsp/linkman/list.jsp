										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													...
													<TD>所属客户：</TD>
													<TD>
														<select name="customer.cust_id" class=textbox id="customer" style="WIDTH: 130px;height: 21px">
															<option value="">-请选择-</option>
														</select>
													</TD>
											...
											<TBODY>
												...
												<s:iterator value="list">
													<TR
														...
														<%-- <a href="${pageContext.request.contextPath }/linkman/LinkManServlet?method=deleteLinkMan&lkmId=${lkm_id}">删除</a> --%>
														</TD>
													</TR>
												</s:iterator>
